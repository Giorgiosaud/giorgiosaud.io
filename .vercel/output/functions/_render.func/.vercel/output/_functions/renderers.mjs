...
import { A as AstroJSX, n as renderJSX, l as createVNode } from './chunks/astro/server_ICIjUNoW.mjs';
...
async function renderToStaticMarkup$3(Component, inputProps, slotted, metadata) {
	const slots = {};
