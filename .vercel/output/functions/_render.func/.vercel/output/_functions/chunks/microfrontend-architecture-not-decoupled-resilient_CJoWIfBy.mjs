const id = "microfrontend-architecture-not-decoupled-resilient.md";
						const collection = "notes";
						const slug = "microfrontend-architecture-not-decoupled-resilient";
						...
						const _internal = {
							type: 'content',
							filePath: "/Users/giorgiosaud/Projects/personal/giorgiosaud.io/src/content/notes/microfrontend-architecture-not-decoupled-resilient.md",
							rawData: undefined,
						};
